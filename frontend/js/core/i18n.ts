...
const i18n = {
    ru: {
        ...
        dict: {
            ...
            subtitlesPanelTitle: "Субтитры",
            closeSubtitlesPanel: "Закрыть субтитры",
            subtitleContextLabel: "Контекст карточки",
            previousContext: "До",
            nextContext: "После",
            addToContext: "Добавить в контекст",
            removeFromContext: "Убрать из контекста",
			...
			ankiSentenceFields: "Поля предложений Anki:",
    ...
    en: {
        ...
        dict: {
            ...
            closeSubtitlesPanel: "Close subtitles",
            subtitleContextLabel: "Card context",
			...
			ankiSentenceFields: "Anki sentence fields:",
    ...
    ja: {
        ...
        dict: {
            ...
            hideSubs: "字幕を隠す",
            showSubs: "字幕を表示",
            subtitlesPanelTitle: "字幕",
            closeSubtitlesPanel: "字幕を閉じる",
            subtitleContextLabel: "カードのコンテキスト",
            previousContext: "前",
            nextContext: "後",
			...
			ankiSentenceFields: "Anki例文フィールド:",
