...
function updateTargetNoteMenuWidth() {
    ...
    const updateTargetNoteMenuWidthState = updateTargetNoteMenuWidth as typeof updateTargetNoteMenuWidth & { canvas?: HTMLCanvasElement };
...
async function prepareAutoAttachTask(word, { copyWord = false, subtitleIndex = null, armKey = "" } = {}) {
    ...
    try {
        const snapshot = buildCurrentAnkiMediaSnapshot({ subtitleIndex }) as ReturnType<typeof buildCurrentAnkiMediaSnapshot> & {
            selectedWord?: string;
        };
