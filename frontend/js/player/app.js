...
videoContainer.addEventListener("click", (event) => {
    ...
    if (target instanceof Element && target.closest("#controls, .subtitle-overlay-line"))
        return;
    if (video.paused)
        video.play();
    else
...
const targetNoteDropdown = createTargetNoteDropdownController({
    ...
    getAnkiUrl: () => document.getElementById("ankiUrl").value,
...
const scheduleAutoAttachCancelIfSelectionCleared = autoAttachQueueController.scheduleCancelIfSelectionCleared;
const clearAutoAttachSelectionCancelTimer = autoAttachQueueController.clearSelectionCancelTimer;
