...
const root = { querySelectorAll(selector) { return selector.includes("reportStatus") ? [checked("reportStatus", "new"), checked("reportStatus", "young")] : [checked("reportSheet", "summary")]; } };
...
assert.deepEqual(JSON.parse(JSON.stringify(payload)), { statuses: ["new", "young"], sheets: { summary: true, occurrences: false, statistics: false } });
